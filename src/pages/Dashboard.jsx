...
export default function Dashboard() {
  ...
  const incomeDelta  = (last && prev)
    ? calcDelta(last.income,   prev.income)
    : null

  const expenseDelta = (last && prev)
    ? calcDelta(last.expenses, prev.expenses)
    : null
      ...
      <div className="page-body page-stack">
        ...
        <div>
          <div className="section-header">
            ...
            {permissions.canAdd && (
              <AddBtn label="Add" onClick={() => setModal('add')} />
            )}
          </div>
          <Table
