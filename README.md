A personal finance tracker. Lets you log transactions, see where your money is going and switch between admin and viewer roles to simulate access control.
